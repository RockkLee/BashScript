...
class FolderToTextGUI:
    def __init__(self, master):
        ...
        self.file_types_label.grid(row=2, column=0, sticky="E")
        self.file_types_entry.grid(row=2, column=1)

        self.output_path_label.grid(row=3, column=0, sticky="E")
        self.output_path_entry.grid(row=3, column=1)

        self.output_filename_label.grid(row=4, column=0, sticky="E")
        self.output_filename_entry.grid(row=4, column=1)

        self.filter_files_label.grid(row=5, column=0, sticky="E")
        self.filter_files_on.grid(row=5, column=1, sticky="W")
        self.filter_files_off.grid(row=5, column=1)
